          ...
          Positioned(
            ...
            child: RotatedBox(
              ...
              child: Slider(
                ...
                onChanged: (value) {
                  // Update the value without triggering an AR node update
                  setState(() {
                    currentScale = value;
                  });
                },
                onChangeEnd: (value) {
                  // Trigger AR node update only when the user releases the slider
                  setState(() {
  ...
  Future<void> _addNodeToAnchor(vector.Matrix4 transformation) async {
    ...
    if (didAddAnchor!) {
      ...
      artworkNode = ARNode(
        ...
        position: vector.Vector3(0.0, 0.05, 0.0), // Positioned relative to the anchor
